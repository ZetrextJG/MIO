...
train_df = pd.read_csv(DATASETS_CLASSIFICATION[1][0])
test_df = pd.read_csv(DATASETS_CLASSIFICATION[1][1])
...
def main():
    ...
    for i in range(REPEATS):
        output_file_sgd = Path(f"./lab6/search_results_rings3_{i}.jsonl")
