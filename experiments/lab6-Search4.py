...
train_df = pd.read_csv(DATASETS_CLASSIFICATION[2][0])
test_df = pd.read_csv(DATASETS_CLASSIFICATION[2][1])
...
def main():
    ...
    for i in range(REPEATS):
        output_file_sgd = Path(f"./lab6/search_results_xor3_{i}.jsonl")
            ...
            for train_outputs, y_test_pred, params in tqdm(
                ...
                results_dict = {
                    ...
                    **train_outputs_sorted,
                    "final_fscore": float(mf.fscore(y_pred, y_test, 2)),
                }
